...
user_messages = {
    ...
    'want_to_trim_voice': 'آیا میخواهید فقط بخشی از این ویس را ثبت کنید ؟',
    'send_duration': 'زمان کات ویس را ارسال کنید، برای مثال :\n0:21-0:43 (از ثانیه 21 تا 43)',
    'meme_already_exists': 'این {0} در ربات موجود میباشد ⚠',
    'invalid_duration': 'زمان ارسال شده کمتر از 0 یا بیشتر از زمان کل ویس است !',
